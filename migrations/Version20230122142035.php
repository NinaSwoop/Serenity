 ...
 */
final class Version20230122142035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE welfare ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE welfare ADD CONSTRAINT FK_C7D1B215A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_C7D1B215A76ED395 ON welfare (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE welfare DROP FOREIGN KEY FK_C7D1B215A76ED395');
        $this->addSql('DROP INDEX IDX_C7D1B215A76ED395 ON welfare');
        $this->addSql('ALTER TABLE welfare DROP user_id');
    }
}
